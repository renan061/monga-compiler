...
define void @main() {
  ...
  %t6 = getelementptr [2 x i8], [2 x i8]* @.str1 , i32 0, i32 0
  call i32 (i8*, ...) @printf(i8* getelementptr ([3 x i8], [3 x i8]* @.pstr, i32 0, i32 0), i8* %t6)
  %t7 = load i8*, i8** %t2
  %t8 = add i32 0, 0
  %t9 = getelementptr i8, i8* %t7, i32 %t8
  %t10 = load i8, i8* %t9
  call i32 (i8*, ...) @printf(i8* getelementptr ([3 x i8], [3 x i8]* @.pchar, i32 0, i32 0), i8 %t10)
  %t11 = getelementptr [2 x i8], [2 x i8]* @.str2 , i32 0, i32 0
  ...
  %t21 = load i8**, i8*** %t3
  %t22 = add i32 1, 0
  %t23 = getelementptr i8*, i8** %t21, i32 %t22
  %t24 = add i32 2, 0
  ...
  %t28 = load i8**, i8*** %t3
  %t29 = add i32 1, 0
  %t30 = getelementptr i8*, i8** %t28, i32 %t29
  %t31 = load i8*, i8** %t30
  %t32 = add i32 0, 0
  ...
  %t36 = load i8**, i8*** %t3
  %t37 = add i32 1, 0
  %t38 = getelementptr i8*, i8** %t36, i32 %t37
  %t39 = load i8*, i8** %t38
  %t40 = add i32 1, 0
